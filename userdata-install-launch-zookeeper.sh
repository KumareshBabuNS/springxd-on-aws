...
# Download the file:
curl -O https://raw.githubusercontent.com/kennyk65/springxd-on-aws/master/install-launch-zookeeper.sh

# Make it executable:
chmod 777 install-launch-zookeeper.sh

# Execute it:
./install-launch-zookeeper.sh
